(() => {
  ...
  function makeSnapshot({ providers = [], chats = [], turns = [], files = [], projects = [], events = [], checkpoints = [], syncReceipts = [], catalogRuns = [], knowledgeItems = [], knowledgeSources = [], projectContinuity = [], meta = {} } = {}) {
    ...
    return {
      ...
      summary: { providers: providers.length, projects: projects.length, chats: chats.length, turns: turns.length, files: files.length, knowledgeItems: knowledgeItems.length, continuityProjects: projectContinuity.length, events: events.length, checkpoints: checkpoints.length, statusCounts },
