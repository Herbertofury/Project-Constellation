...
const sourceFiles = ['core.js','brain-core.js','provider-core.js','integrity-core.js','knowledge-core.js','health-core.js','chatgpt-page-probe.js','live-sentinel.js','tab-beacon.js','content.js','pulse-ux.js','tab-supervisor-core.js','tab-supervisor-background.js','approval-supervisor-background.js','tab-supervisor.js','styles.css'];
