...
const sourceFiles = ['core.js','brain-core.js','provider-core.js','integrity-core.js','knowledge-core.js','project-memory-core.js','health-core.js','drive-sync-policy.js','drive-sync-guard.js','chatgpt-page-probe.js','live-sentinel.js','tab-beacon.js','content.js','pulse-ux.js','tab-supervisor-core.js','tab-supervisor-background.js','approval-supervisor-background.js','tab-supervisor.js','hidden-download-capture.js','styles.css'];
