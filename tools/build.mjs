...
const sourceFiles = [
  ...
  'chat-vault-core.js','chat-organizer.js','chat-organizer.css','notification-repair.js','command-center-action-core.js','closed-chat-watch-core.js','closed-chat-watch.js','command-center-actions.js'
];
