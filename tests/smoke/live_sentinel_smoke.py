...
with sync_playwright() as p:
    ...
    page.evaluate("""() => { const h=document.getElementById('projectConstellationHealthHud'); h.dataset.watchdog='10'; h.dataset.state='capacity-handoff'; h.dataset.level='danger'; }""")
