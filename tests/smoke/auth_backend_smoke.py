...
brain=(root/'src/brain-core.js').read_text(); providers=(root/'src/provider-core.js').read_text(); integrity=(root/'src/integrity-core.js').read_text(); knowledge=(root/'src/knowledge-core.js').read_text(); memory=(root/'src/project-memory-core.js').read_text(); router=(root/'src/project-router-core.js').read_text(); health=(root/'src/health-core.js').read_text(); bg=(root/'background.js').read_text()
